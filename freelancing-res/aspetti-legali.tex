...
Come si \'e detto, l'IRPEF \'e imposto sulle persone fisiche e sulle ditte individuali. 
L'IRPEF \'e un sistema progressivo di reddito, ovvero il totale delle tasse pagate varia in base agli incassi ottenuti nell'anno, sottratti delle spese (deducibili e detraibili) sostenute e dei contributi versati. 
I suddetti scaglioni variano per il 23\%, 35\% e 43\%, per redditi da 0 a 28.000 euro, da 28.000,01 a 50.000 euro ed oltre 50.000 euro, rispettivamente.

Inoltre \'e prevista una no tax area per redditi al di sotto di 5.500 euro all'anno.

Si ripete che il reddito imponibile \'e dato dalla formula: $imponibile = incassi - spese - contributi$.

Un altro tipo di imposta \'e la ritenuta d'acconto. Se il cliente presso cui svolgi un servizio o vendi un bene \'e un attivit\'a
allora dovrai inserire in fattura la ritenuta d'acconto del 20\%. Si tratta di un anticipo sulle tasse che il cliente trattiene dal compenso che dovrebbe pagarti e poi versa allo stato al posto tuo.

A differenza del regime forfetario, nel regime ordinario \'e prevista l'applicazione dell'IVA ai propri costi, da versare successivamente allo stato. Realmente viene pagata dai clienti, mettendo un aumento del prezzo in linea con la percentuale da pagare.
L'IVA applicata pu\'o essere del 4\%, 5\%, 10\% o del 22\% del prezzo del prodotto. 
...
\subsection{Ditta individuale a Regime fiscale ordinario od ordinario semplificato}
\subsubsection{Reddito pari a 10.000 euro}
\begin{itemize}
    \item Costi deducibili:
    \item Costi detraibili:
    \item Contributi INPS: 
    \item Reddito: 10.000 euro
    \item Reddito Imponibile: Reddito - Costi deducibili - Costi detraibili - Contributi INPS: 
    \item IRPEF
    \item IVA: -
    \item Costo Commercialista: 2000 euro/annuo
\end{itemize}

\subsection{SRL a regime fiscale ordinario od ordinario semplificato}
...
\subsubsection{Contratto di sviluppo per professionisti}
Contratto d'opera
...
\subsubsection{Contratto di sviluppo per societ\'a}
Contratto d'appalto
